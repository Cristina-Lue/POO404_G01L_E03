...
<div class="container">
    ...
    <form action="controller.jsp" method="POST">
        ...
        <div class="form-group">
            <label for="edad">Ingrese la edad de la persona:</label><div class="input-group">
        ...
        <div class="form-group">
            ...
            <div class="input-group"><select name="idocupacion" id="ocupacion" class="form-control" required>
