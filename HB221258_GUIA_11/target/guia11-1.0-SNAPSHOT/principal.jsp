...
<c:forEach var="persona" items="${q1.rows}">
    ...
    <td>${persona.fecha_nac}</td>
        ...
        <td>
            <a class="btn bg-primary" href="controllercontroller.jsp?operacion=modificar&id=${persona.id_persona}">Modificar</a>
            </form>
        </td>
    </tr>
</c:forEach>
    ...
    <script>
        ...
        {
            let mensaje;
            const opcion = confirm("Esta seguro de eliminar este registro");if (opcion == true) {
