...
<%
        st = conexion.prepareStatement("INSERT INTO persona(nombre_persona, edad_persona, telefono_persona, sexo_persona, id_ocupacion, fecha_nac) VALUES(?,?,?,?,?,?)");
        ...
        st.setInt(5, ocupacion.getIdOcupacion());st.setString(6, persona.getFechaNac());
    st.executeUpdate();
%>
<!DOCTYPE html>
<html lang="es">
...
<div class="container">
    <ul class="list-group">
        ...
        <li class="list-group-item"><strong>
<jsp:getProperty name="persona" property="edadPersona"/></strong></li>
        <li class="list-group-item"><strong>
